...
> Scaffold Chaos Mesh experiment definitions, container stress simulations, and resilience validation runbooks.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/chaos/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/chaos/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-chaos.git
cd tp-chaos
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/chaos/) |
